...
export const metadata: Metadata = {
  ...
  description:
    "東鐵工程提供全方位橡矽膠成型解決方案，包含 FIFO 先進先出射出機、臥式/立式射出機、真空熱壓成型機及自動化週邊設備。",
  ...
  openGraph: {
    ...
    description:
      "全方位橡矽膠成型解決方案，包含 FIFO 先進先出射出機、真空熱壓成型機及自動化週邊設備。",
...
export default function RootLayout({
  ...
  return (
    <html lang="zh-TW">
      <body className={`antialiased ${plusJakartaSans.className} bg-white selection:bg-red-100 overflow-x-hidden`}>
        {/* 注入 JSON-LD */}
        <script
